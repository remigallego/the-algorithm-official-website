...
const LogoSvg: FunctionComponent<Props> = () => {
  ...
  const renderGreenLogo = () => {
    return (
      ...
      >
        <AnimatedMovement xOffset={4.1} yOffset={-8}>
          <svg
  ...
  const renderRedLogo = () => {
    return (
      ...
      >
        <AnimatedMovement xOffset={2.1} yOffset={3.4}>
          <svg
            id="logo2"
            viewBox="0 0 628 414.3"
            fill="none"
  ...
  const renderBlueLogo = () => {
    return (
      ...
      >
        <AnimatedMovement xOffset={-4.5} yOffset={10.9}>
          <svg
            id="logo3"
            viewBox="0 0 628 414.3"
            fill="none"
  ...
  return (
    <div
      onMouseMove={(e) => {
        ...
        if (x + offset >= mouseCoords.x && x - offset <= mouseCoords.x) {
          return;
        }
        if (y + offset >= mouseCoords.y && y - offset <= mouseCoords.y) {
          return;
        }
        setMouseCoords({ x, y });
      }}
